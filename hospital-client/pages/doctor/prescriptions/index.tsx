...
import { getReadOnlyPrescriptionsUnderDoctor } from "@/redux/actions/doctorActions";
  ...
  return (
    ...
    <div className="max-w-7xl mx-auto">
      <div className="flex flex-wrap justify-center lg:justify-normal flex-col lg:flex-row mt-3 px-6 gap-6">
        {doctors.prescriptions.map(
          (data: PatientDetailsUpdateByDoctor, index: number) => {
            return <PatientsUnderDoctor key={index} patientDetail={data} disabledUpdate={true} />;
          }
        )}
      </div>
    </div>
