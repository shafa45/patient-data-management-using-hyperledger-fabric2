import { PatientPrescritionDetailsUpdateByDoctor } from "@/types/patient";
...
import UpdatePatientPersonalDetail from "./UpdatePatientPersonalDetails";

const PatientPrescription: React.FC<{
  prescriptionDetail: PatientPrescritionDetailsUpdateByDoctor;
}> = ({ prescriptionDetail }) => {
            ...
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="  overflow-hidden transform  rounded-2xl  text-left shadow-xl transition-all">
                  ...
                  /> */}
                  <UpdatePatientPersonalDetail patientDetail={prescriptionDetail} />
                </Dialog.Panel>
              </Transition.Child>
            </div>
          </div>
            ...
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="transform  rounded-2xl text-left shadow-xl transition-all m-3 overflow-auto">
                  ...
                  <PrescriptionHistoryRecords prescriptionId={prescriptionDetail.prescriptionId} />
                </Dialog.Panel>
              </Transition.Child>
            </div>
          </div>
