import { PatientPersonalDetails, PatientDetailsUpdateByDoctor } from "@/types/patient";
...
const PatientsUnderDoctor: React.FC<{
  ...
  const [pat, setPat] = useState({} as PatientPersonalDetails);
  ...
  const getPatientById = async () => {
    try {
      ...
      const response = await axiosInstance.get(
        `${API_BASE_URL}/patients/${patientDetail.patientId}`
      );
      console.log("pat details", response.data)
